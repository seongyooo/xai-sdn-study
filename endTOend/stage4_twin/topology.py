"""
stage4_twin/topology.py — Mininet 다이아몬드 토폴로지
...
실제 구성:
  h1(10.0.0.1) - s1
  h2(10.0.0.2) - s1   (s1에 h1, h2 연결)
  h3(10.0.0.3) - s4
  h4(10.0.0.4) - s4   (s4에 h3, h4 연결)
  s1 - s2 - s4  (저속 경로, 1Mbps)
  s1 - s3 - s4  (고속 경로, 10Mbps)

Mininet 임포트는 이 파일을 임포트하는 순간이 아닌
build_network() 함수 내부에서만 수행한다 (Linux 환경 체크 후 호출).
"""
